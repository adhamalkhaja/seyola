...
**Read an existing HTML report file and reconstruct the business state for continued work.**

---

## Purpose

When user has been working on a diagnose diagram and wants to continue with AI assistance, this workflow:
1. Reads the .html XML
...
> "I can scan your existing diagnose diagram. Please either:
> - Paste the file path (e.g., `diagrams/Business Map.html`)
...
- Identify which standard pages exist:
  - Business Overview (Business Map + Bow-Tie on Page 1)
...
#### From Bow-Tie Section (bottom of Page 1)
...
> "Here's what I found in your diagnose:
>
> **Page 1 - Business Overview:**
> - [x] Business Map (top section)
> - [x] Bow-Tie Funnel (bottom section)
>
> **Process Pages:**
...
### Find Pages
```xml
<diagram name="Business Overview" id="page-1">  <!-- Contains Business Map + Bow-Tie -->
...
```yaml
# diagnose Progress - Reconstructed from diagram
...
> "I've scanned your diagnose. Here's the current state:
>
...
### Invalid XML
> "The file doesn't appear to be a valid HTML report file. Make sure it's the right file and try again."

### Empty Diagram
> "This diagram appears to be empty or just starting. Would you like to begin the diagnose interview from scratch?"

### Unrecognized Structure
> "I found content but it doesn't match the standard diagnose layout. I can see [X pages]. Would you like me to describe what I found, or start fresh with the standard template?"
